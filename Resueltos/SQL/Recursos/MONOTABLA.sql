...
# EJ67 SELECCIONA EL CODIGO DE LOS PAISES, LAS 3 PRIMERAS LETRAS DE SU NOMBRE EN MAYUSCULA
# Y UNA COLUMNA QUE INDIQUE SI LAS DOS ANTERIORES COINCIDEN

SELECT
	COUNTRY_ID,
	UPPER(LEFT(COUNTRY, 3)) AS TRES_PRIMERAS,
	COUNTRY_ID=UPPER(LEFT(COUNTRY,3)) AS IGUALES
FROM COUNTRY;

# EJ68 PARA CUANTOS PAISES COINCIDEN LOS CODIGOS DE 3 LETRAS.
